...
class Routes {
  ...
  static Route generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case complaintForm:
        {
          ComplaintFormArguments args =
              settings.arguments as ComplaintFormArguments;
          return MaterialPageRoute(
      ...
      case complaint:
        {
          ComplaintArguments args = settings.arguments as ComplaintArguments;
          return MaterialPageRoute(
              builder: (context) => ComplaintScreen(complaint: args.complaint));
        }
      // case product:
      //   {
